...
$$
2i - 1, \quad i = 1, 2, 3, \dots, k
$$

The sum of the squares of the first \(k\) odd numbers is:
...
$$
\sum_{i=1}^{k} i = \frac{k(k+1)}{2}, \quad \sum_{i=1}^{k} i^2 = \frac{k(k+1)(2k+1)}{6}, \quad \sum_{i=1}^{k} 1 = k
$$

We get:

$$
\sum_{i=1}^{k} (2i - 1)^2 = 4 \cdot \frac{k(k+1)(2k+1)}{6} - 4 \cdot \frac{k(k+1)}{2} + k
$$

Simplifying yields the final formula:
...
For the first 526,000 square numbers, the number of odd squares is:

$$
k = \frac{526000}{2} = 263000
$$

The sum of odd squares is:

$$
\text{Sum} = \frac{k(2k-1)(2k+1)}{3}
$$
